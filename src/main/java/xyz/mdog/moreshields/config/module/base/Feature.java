package xyz.mdog.moreshields.config.module.base;

import xyz.mdog.moreshields.config.module.base.config.Config;
import xyz.mdog.moreshields.config.module.base.config.Difficulty;
import xyz.mdog.moreshields.config.module.base.config.MinMax;
import xyz.mdog.moreshields.config.module.util.IdTagMatcher;
import xyz.mdog.moreshields.config.module.base.config.Blacklist;
